...
class Root(Tk):
    ...
    def RunPro(self):
        ...
        net = cv2.dnn.readNetFromCaffe("C:/Users/Chethan Reddy/OneDrive/Desktop/model/colorization_deploy_v2.prototxt",
                                       "C:/Users/Chethan Reddy/OneDrive/Desktop/model/colorization_release_v2.caffemodel")
        pts = np.load("C:/Users/Chethan Reddy/OneDrive/Desktop/model/pts_in_hull.npy")
        ...
        colorized = cv2.resize(colorized, (1080, 720))
